...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-favorites-favorites-module"], {
  ...
  function srcAppPagesFavoritesFavoritesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FavoritesPage = /*#__PURE__*/function () {
      function FavoritesPage(navCtrl, translate, venues) {
      ...
      _createClass(FavoritesPage, [{
        ...
        value: function deleteItem(favorite) {
          ...
          this.venues.unfavorite(favorite).then(function () {
            _this.getFavorites();
        ...
        value: function getFavorites() {
          ...
          this.venues.getFavorites().then(function (data) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _providers__WEBPACK_IMPORTED_MODULE_3__["TranslateProvider"], _providers__WEBPACK_IMPORTED_MODULE_3__["VenueProvider"]])], FavoritesPage);
    /***/
  }
}]);
